...
class DbPedia(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/db_pedia.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
...
class YelpReview(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/yelp_review_full.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 5
        self.epoch_size = 5000
...
class YelpPolarity(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/yelp_review_polarity.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 2
        self.epoch_size = 5000
...
class AmazonReview(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/amazon_review_full.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 5
...
class AmazonPolarity(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/amazon_review_polarity.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 2
        self.epoch_size = 30000
...
class SoguNews(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/sogou_news.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 5
        self.epoch_size = 5000
...
class YahooAnswer(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/yahoo_answers.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 10
...
class Imdb(object):
    ...
    def __init__(self):
        ...
        self.url = "https://s3.amazonaws.com/fast-ai-nlp/imdb.tgz"
        self.data_name = os.path.basename(self.url).split(".")[0] # ag_news
        self.data_folder = "{}/{}/raw".format(DATA_FOLDER, self.data_name)
        self.n_classes = 2
